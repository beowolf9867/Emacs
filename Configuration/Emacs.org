#+PROPERTY: header-args:emacs-lisp :tangle /Users/abdul/Projects/Emacs/Configuration/init.el
...
*** Org-agenda
 ...
 - To add notifications with the macOS, we need to install ~org-alert~
   - ~M-x package-install RET org-alert RET~
